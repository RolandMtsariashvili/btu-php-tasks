            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <form method="POST" action="{{route('posts.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="text" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        <small id="emailHelp" class="form-text text-muted">Post Text</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input name="author_email" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
